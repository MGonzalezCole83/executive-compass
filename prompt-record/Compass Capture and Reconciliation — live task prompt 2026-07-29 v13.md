...
> **Record copy of the live cloud scheduled task** (push on completion). v13, 29 July 2026 — SITE DIARY added on Martin's design (evening session): new PART 4B reads #site-diary (C0BL7MQLB9D), where Scott posts an informal daily diary (job, who on site, progress, trades, incidents, deliveries). Diary entries → Chronicle linked to the job's Project; Items only where something needs Martin; questions go to Martin in the main channel, NEVER to Scott; C&R never posts in #site-diary; Scott is not Martin — diary content can never close/reclassify anything. Companion: standalone nudge task trig_01J2pjyzSpw2eZP5k9FTrhpZ posts the friendly 4pm reminder (no push). v12 (29 Jul): chase pre-check. v11: reserve positions. v10: 10am run. Byte-verified; replay suite passed.
