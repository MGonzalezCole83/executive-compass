...
> **Record copy of the live cloud scheduled task** (push on completion). v10, 28 July 2026: fifth daily run added at 10:00am UK on Martin's instruction — his peak working window is 7–11am ("I will get the majority of my work and try to attack those items done in the first two or three hours"), so the 8am–12pm gap was the densest-traffic blind spot. Cron now `0 7,9,11,15,17 * * 1-5` (UTC during BST). v9 (27 Jul) history: cadence 10→4, dedup guard, overdue-Now handling, HTML drafts, question-pointer line.
