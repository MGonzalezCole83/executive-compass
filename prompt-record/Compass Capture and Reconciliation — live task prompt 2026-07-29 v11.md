...
> **Record copy of the live cloud scheduled task** (push on completion). v11, 29 July 2026 — companion to Briefing v2 (expectation engine): new RESERVE POSITIONS section (no automated output ever spends a held-back position), and PART 4 now records replies to the Briefing's "Expected outcome" question as full Chronicle context (expected outcome, risks, strategy, reserves), not classification changes. v10 (28 Jul): fifth daily run at 10am UK.
